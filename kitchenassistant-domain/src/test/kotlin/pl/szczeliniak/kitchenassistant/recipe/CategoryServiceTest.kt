...
class CategoryServiceTest {
    ...
    fun shouldThrowExceptionWhenReturnAllAndTokenTypeOtherThanAccess() {
        ...
        val exception = assertThrows<KitchenAssistantException> { categoryService.getAll() }
    ...
    fun shouldThrowExceptionWhenAddCategoryAndTokenTypeOtherThanAccess() {
        ...
        val exception = assertThrows<KitchenAssistantException> { categoryService.add(NewCategoryRequest("")) }
    ...
    fun shouldThrowExceptionWhenUpdateCategoryAndTokenTypeOtherThanAccess() {
        ...
        val exception = assertThrows<KitchenAssistantException> { categoryService.update(1, UpdateCategoryRequest("")) }
    ...
    fun shouldThrowExceptionWhenDeleteCategoryAndTokenTypeOtherThanAccess() {
        ...
        val exception = assertThrows<KitchenAssistantException> { categoryService.delete(1) }
